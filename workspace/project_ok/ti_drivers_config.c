...
GPIO_PinConfig gpioPinConfigs[] = {
    /* Board_GPIO_LED0 : LaunchPad LED 2 Red */
    GPIOMSP432_P2_0 | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_MED |
    GPIO_CFG_OUT_LOW,
    ...
    GPIO_CFG_OUT_HIGH,
    /* MSP_EXP432P4111_GPIO_S1 : LaunchPad Button S1 (Left) */
    GPIOMSP432_P1_1 | GPIO_CFG_IN_PU | GPIO_CFG_IN_INT_FALLING,
    /* MSP_EXP432P4111_GPIO_S2 : LaunchPad Button S2 (Right) */
...
const Timer_Config Timer_config[CONFIG_TIMER_COUNT] = {
    ...
    {
        .fxnTablePtr = &TimerMSP432_Timer32_fxnTable,
        .object      = &timerMSP432Objects[Board_TIMER1],
        .hwAttrs     = &TimerMSP432HWAttrs[Board_TIMER1]
    },
};
...
static const Button_HWAttrs ButtonHWAttrs[2] = {
    ...
    {
        .gpioIndex = MSP_EXP432P4111_GPIO_S1
    },
    /* Board_GPIO_BUTTON1 */
    /* LaunchPad Button S2 (Right) */
    {
        .gpioIndex = MSP_EXP432P4111_GPIO_S2
    },
};
